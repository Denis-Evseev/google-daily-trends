...
def get_daily_trend(trendreq, keyword: str, start: str, end: str, cat=0,
    ...
    while end_d > start_d:
        ...
        temp = _fetch_data(trendreq, pd.Series(data=[keyword]), timeframe=tf, cat=cat, geo=geo, gprop=gprop)
...
def main():
    ...
    for index, row in df.iterrows():
        ...
        print("Processing Ticker: " + row['ticker'] + " Keyword: " + row['keyword'])
        daily_fetched_data = get_daily_trend(pytrend, row['keyword'], "2020-01-01", "2021-05-01")
